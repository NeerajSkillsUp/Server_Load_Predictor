...
app = Flask(__name__)
CORS(app)
print("--- Loading M7_daily Model and Data ---")

# Define file paths
MODEL_NAME = "A7 files\\M7_daily.joblib"
DATA_NAME = "A7 files\\A7_daily_calls.csv"
...
try:
    ...
    print(f"FATAL: Could not load model artifacts. Run train_M7_daily.py first. Error: {e}")
    MODEL = None

# --- 2. Define Prediction Endpoint ---
@app.route('/predict', methods=['GET'])
def predict():
    """Predicts the next DAY's call count for A7."""
