import pandas as pd
import numpy as np
from xgboost import XGBRegressor  # <-- Changed from RandomForest
import joblib
import warnings

warnings.filterwarnings("ignore")

print("--- Starting Final M2 (XGBoost, Daily) Training ---")
MODEL_NAME = "A2 files\\M2_daily.joblib"
DATA_SOURCE_RAW = "A2 files\\A2.csv"
DATA_SOURCE_PROCESSED = "A2 files\\A2_daily_calls.csv"
...
if X.empty:
    ...
    # Instantiate XGBoost model (using params from notebook)
